...
import org.fastcampus.student_management.repo.CourseJdbcRepositoryImpl;
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    CourseCommandRepositoryImpl courseCommandRepositoryImpl = new CourseCommandRepositoryImpl();
    CourseJdbcRepositoryImpl courseJdbcRepositoryImpl = new CourseJdbcRepositoryImpl();

    StudentService studentService = new StudentService(studentRepository);
    CourseService courseService = new CourseService(courseCommandRepositoryImpl,courseJdbcRepositoryImpl,studentService);
